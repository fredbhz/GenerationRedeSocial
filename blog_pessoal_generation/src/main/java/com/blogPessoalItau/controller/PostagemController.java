...
public class PostagemController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Postagem> getById(@PathVariable Long id){  //PathVariable => para identificarmos qual é a variavél no caminho da URI
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT) //No content => 204
    @DeleteMapping("/{id}")
